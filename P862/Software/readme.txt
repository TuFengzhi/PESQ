--------------------------------------------------------------
*** README file for ITU-T P.862 Version 1.2 software
*** Reference implementation of PESQ (perceptual evaluation
*** of speech quality) and conformance data
--------------------------------------------------------------
...
CONFORMANCE DATA:
conform\supp23.txt 	Conf. data, ITU-T P-series Suppl.23
conform\supp23.bat

conform\voipref.txt 	Conf. data, variable delay conditions
conform\voipref.bat
